...
\item Yanbang Kan: Collectively try another network architecture to compare, work on the final presentation, slides and report
\item Maria Mangassarian: Collectively try another network architecture to compare, work on the final presentation, slides and report
\end{itemize}
